export const yaka_maksymalna_pensiia_u_2025 = {
  'yaka-maksymalna-pensiia-u-2025': {
    title: 'Яка максимальна пенсія у 2025 році? | Адвокат Поддяча Юлія Юріївна',
    description:
    ...
    keywords:
      'максимальна пенсія 2025, прожитковий мінімум для непрацездатних, обмеження пенсії, судді у відставці, обмеження пенсії військовослужбовцям, Пенсійний фонд, пенсійне право',
    type: 'article',
      ...
      '@graph': [
        {
          ...
          description:
            'Максимальна пенсія в Україні у 2025 році. Як обчислюється максимальний росмір пенсії. Дізнайтеся, кого не стосуються обмеження, як їх оскаржити та коли можна підвищити виплати.',
          datePublished: '2025-09-28T19:30:00+03:00',
          dateModified: '2025-09-28T19:30:00+03:00',
          dateCreated: '2025-04-18T19:00:00+03:00',
          author: {
            '@type': 'Person',
          ...
          keywords: [
            ...
            'прожитковий мінімум для непрацездатних',
            'обмеження пенсії',
            'судова практика',
            'судді у відставці',
            'військовослужбовці',
