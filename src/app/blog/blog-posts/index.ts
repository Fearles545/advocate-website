...
export const blogs = [
  {
    title:
      'Мінсоцполітики виставило проєкт аналогічної постанови на заміну протиправної постанови КМУ №821',
    slug: 'holosuvannia-proty-proiektu-kmu-821',
    src: [] as string[],
    date: '2026-04-02',
    categories: ['general'] as const,
    description:
      'Суд визнав постанову КМУ №821 протиправною, але Мінсоцполітики виставило аналогічний проєкт. Покрокова інструкція як проголосувати проти на сайті msp.gov.ua через BankID.',
    faq: [
      {
