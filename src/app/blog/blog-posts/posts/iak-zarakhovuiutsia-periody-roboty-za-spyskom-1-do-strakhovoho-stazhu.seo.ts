export const iak_zarakhovuiutsia_periody_roboty_za_spyskom_1_do_strakhovoho_stazhu =
  {
    'iak-zarakhovuiutsia-periody-roboty-za-spyskom-1-do-strakhovoho-stazhu': {
      title:
        'Як зараховуються періоди роботи за Списком №1 | Адвокат Поддяча Юлія Юріївна',
      description:
