export const chy_mozhna_zarakhovaty_periody_roboty_u_pilhovyi_stazh_iakscho_na_pidpryiemstvi_ne_provodyly_atestatsiiu_robochykh_mists =
  {
    'chy-mozhna-zarakhovaty-periody-roboty-u-pilhovyi-stazh-iakscho-na-pidpryiemstvi-ne-provodyly-atestatsiiu-robochykh-mists':
      {
        title:
          'Пільговий стаж без атестації робочих місць | Адвокат Поддяча Юлія Юріївна',
        description:
