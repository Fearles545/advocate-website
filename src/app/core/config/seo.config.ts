...
export const SEO_DATA: { [key: string]: PageSEO } = {
  main: {
    title: 'Адвокат по пенсіях Поддяча Юлія | Допомога з пенсією',
    description:
      'Адвокат з пенсійних питань — призначення та перерахунок пенсії без відвідування ПФУ. Пенсії за віком, за вислугу років та інші. 10+ років досвіду.',
    keywords:
